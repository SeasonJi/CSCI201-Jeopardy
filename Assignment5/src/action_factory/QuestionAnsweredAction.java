...
public class QuestionAnsweredAction extends Action{
	...
	public void executeAction(MainGUINetworked mainGUI, ServerGameData gameData, Message message,
		...
		//hw5 new parameters
		//reset every team's buzzin
		currentQuestion.isBuzzinTeam = false;
		
		if(client.getTeamIndex()==currentQuestion.getOriginalTeam())
		{
			currentQuestion.getGameTimer().reset();
		}
		
		if(answer.equals("No more buzzin"))
		{
